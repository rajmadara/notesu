...
import { Calendar, Ellipsis, Plus, Trash2 } from 'lucide-react'
...
export function SpacePage({ space, items, tasks, onOpenItem, onCreateItem, onUpdateSpace, onDeleteSpace }: Props) {
  ...
  return (
    <div className="space-page">
      <HeaderTitle>
        ...
        />
        <div className="menu-anchor">
          <button type="button" className="icon-btn" onClick={() => setMenuOpen((v) => !v)} aria-label="Space options" aria-expanded={menuOpen}>
            <Ellipsis size={16} />
          </button>
          {menuOpen && (
